document.addEventListener("DOMContentLoaded", function () {
  ...
  var scenes = [
    ...
    { chapter: "1987 · 杭州", speaker: "旁白", mood: "end", text: "二十多年后，你回到杭州，蹬起三轮车，代销汽水、棒冰和文具。后来那场广告豪赌的家底，就要从这一单单生意里攒出来。", ending: true }
  ];
  var current = 0;
  ...
  function render() {
    ...
    next.textContent = scene.ending ? "蹬上三轮车 · 开始接单" : "点击继续";
  }
  function advance() {
