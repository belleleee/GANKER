...
const KNOWLEDGE_CARDS = [
  {
    id: 'menu-guide',
    title: '股市菜单怎么用',
    short: '四层操作，先认清自己在哪一层',
    body: [
      '这个房间的操作其实分四层，别被按钮多吓到——先认清自己现在是哪个身份，选项就清楚很多。',
      '<strong>📊 研究</strong>：左侧股票列表看行情，中间图表下面有基本面（营收/利润/现金/负债）和"记下你的估值"，这一层只看不花钱，判断的基础都在这。',
      '<strong>💵 交易</strong>：右侧买/卖/融资买，这里动的是你个人的钱和持仓，判断"这只股票该不该拿"。',
      '<strong>🏢 创始人</strong>：只在选中"公司上市"（WAHA）时出现，因为WAHA是你自己的公司——套现是卖你个人的股份换钱，增发是公司发新股融资，这两个动的账户完全不一样，页面上都写清楚了"钱进哪"。',
      '<strong>🤝 资本运作</strong>：同样在WAHA页面，并购是花公司账上的钱把别的上市公司整个买下来，跟"买它的股票"是两回事——并购后对方直接退市。',
      '不知道该做什么的时候，先去研究层把基本面和新闻看一遍，记一次你自己的估值，再回交易层决定买不买——这是最稳的顺序。'
    ]
  },
  {
    id: 'market-basic',
  ...
  },
  {
    id: 'founder-ops',
    title: '创始人的三种操作',
    short: '套现、增发、并购分别动谁的账',
    body: [
      'WAHA是你自己创业的公司，所以除了普通买卖，你还有三件只有创始人才能做的事——分清"钱进哪"是理解它们的关键。',
      '<strong>创始人套现</strong>：卖掉你个人手里的创始人股份，折价出手，钱直接进你的个人钱包（跟主游戏现金流共用）。公司账上不会多一分钱，但你的持股比例是真的会降下去。',
      '<strong>公司增发</strong>：公司发行新股卖给公开市场，钱进公司账上（治理金库），不进你个人腰包。你手里股数没变，但总股数变多了，持股比例被动稀释——这才是真正的"融资"。',
      '<strong>并购</strong>：花公司账上的钱，把另一家上市公司整体买下来，对方直接退市。这跟"买它的股票"完全是两回事：买股票是你个人持仓的一部分，并购买下的是整家公司，钱也是公司出的。',
      '持股比例还决定"控制权"：跌到67%以下开始有被联合否决的风险，跌到34%以下基本就说了不算了。每次套现或增发前，页面都会把新的持股比例和控制权风险算给你看，别只看到手的钱有多少。'
    ]
  },
  {
    id: 'deep-systems',
    ...
    short: '信息是练出来的，不是等来的',
    body: [
      '这个房间不只是买卖，还有一整套"怎么判断"的练习——地图上的农场主、咖啡馆顾客、杂货铺都能打听到市场消息，但每天限3次，逼你想清楚今天去哪儿听。',
      '打听到的消息、新闻屏上的大部分消息，可信度不是摆设——中等可信度的消息过几天会真正"揭晓"一次，资讯栏能看到"待验证→已证实/已证伪"，证伪的话价格会被打回去一部分。',
      '买入的时候，宗庆后会先问你"为什么买"——选的理由不影响能不能买，但会看出你这一笔到底是算过账，还是听风就是雨，还是纯凭感觉。',
      '每满7个交易日，资讯栏会弹出一张复盘卡片：这周资产从哪到哪、声誉涨跌、这周信过的消息最后有多少条被证实——比"有没有赚到钱"更能看出判断本身有没有在变好。',
      '把这些串起来就是完整的一轮："打听/看新闻→记下自己的估值→决定买卖→推进交易日看结果→隔几天验证消息真假→7天后复盘这段时间的判断质量"。'
    ]
  }
];
