...
const NEWSPAPER_ISSUES = [
    ...
    },
    {
        date: '往事版 · 老照片专栏',
        title: '小屋角落多了一位宗师傅',
        body: '一次炼金事故之后，小屋里多了一位来历不明的老人。他不讲魔法，也不讲发财秘诀，只盯着货架、土地和现金。报社暂时只知道大家叫他“宗师傅”：他以前好像蹬过三轮，也卖过不少东西。至于他到底是谁，故事和账本一样，得一步步翻。'
    },
    {
        date: '经营版 · 森林来信',
        title: '代销订单正式挂牌',
    ...
    },
    {
        ...
        body: '左上角新增了一块"现金流"面板：不只告诉你现在有多少钱，还会提前算出未来几天有哪些必须花的钱、哪些等着回款。真遇到快要见底的情况，面板会主动提醒，别等余额跳到负数才后知后觉。缺钱的时候，贷款、清仓甩卖——挑一个能接受代价的，先撑过去。'
    },
    {
        date: '警示版 · 别上头',
