...
function promptRentFirstTime() {
    openLandPanel(
        ...
        [
            ...
            { speaker: '师傅', text: '我十几岁那会儿，也是从一块地开始的——插秧、挑担、晒谷，天不亮就下地，天黑透了才收工，手心磨出茧子才算真正学会种地。' },
            { speaker: '你', text: '那时候不觉得苦吗？' },
            { speaker: '师傅', text: '苦是真苦。夏天双抢，一边抢收一边抢种，人晒得脱皮，蚂蟥爬满小腿都顾不上拍；冬天挑河泥，河水冰得刺骨，脚底板早就没了知觉。' },
            { speaker: '你', text: '那你后来怎么还愿意接着干？' },
            { speaker: '师傅', text: '没得选。家里穷，能有块地种、有口饭吃，就已经是运气。干着干着就想明白了——地不哄人，你种下去多少心思，它就给你长多少东西，一分都不会少你的，也不会多给你的。' },
            { speaker: '师傅', text: '后来做别的生意，我也是照这个理儿来的：先蹲下去，把最累最脏的活干扎实了，再谈以后。这块地也一样，先下手，才有后面的事。' },
