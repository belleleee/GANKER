...
const GUIDE_STEPS = [
    ...
    {
        text: '看得差不多了吧？大门解锁了。左侧主线目标能打开路线图，看看走到哪一章；怎么选、什么时候收手，还得你自己判断。',
        holdSeconds: 7,
...
const LOCATION_INTROS = [
    ...
    { id: 'invest', x: -12.0, z: 8.5, radius: 6, text: '这是股市小屋。走完代销小摊那一步就能进来；先读新闻，再决定要不要拿自己的钱冒险。' }
];
...
const ONBOARDING_STEPS = [
    ...
    },
    {
        ...
        body:
            ...
            '<br>攒到第一桶金、完成代销小摊后，股市小屋就会开放。左侧主线目标可以打开路线图，看看下一章走向哪里；经营判断仍要由你来做。'
    },
    {
        kicker: '记在心里的规矩',
        title: '这些选择，真的会改变数字',
        body:
            '这只史莱姆遇到的选择，不是只有台词不一样，背后都挂着实打实的数值——不信可以试试看：' +
            '<br>• <b>雇工诚信</b>：农场帮手的工资连续按时发，每 5 天他干活速度 +5%（封顶 +30%）；拖欠工资闹罢工，补发之后也不会立刻恢复，得熬 3 天信任期。' +
            '<br>• <b>投机风险</b>：钱滚钱商店连续把钱包输光 3 次，大门会被真的锁上 3 天——不是说说而已。' +
            '<br>• <b>慈善口碑</b>：累计捐款越多，口碑越高（捐满 2000 金币封顶），广告骗局少坑你、民间融资也更容易谈成。' +
            '<br>• <b>主线选择</b>：广告豪赌、兼并国企、非常可乐这几个关键决定，会永久改变送货订单的报酬/上限、茶叶的收购价——具体改了什么，选完当场就会告诉你。' +
            '<br>这条路怎么走，账本会记得。'
    },
    {
        kicker: '成就墙',
    ...
    },
    {
        ...
        body:
            ...
            '</div>' +
            '<p class="onboardingHint">左侧主线目标可以打开路线图；这份说明随时可以在菜单"世界"标签页里重看。</p>'
    },
    {
        kicker: '第一个决定',
        title: '要不要 all-in？',
